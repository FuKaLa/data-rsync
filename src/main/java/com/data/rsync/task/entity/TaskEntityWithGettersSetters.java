...
/**
 * 任务实体类，手动添加getter和setter方法
 */
@Data
@TableName("task")
public class TaskEntityWithGettersSetters {
    ...
    @TableField(value = "interval", exist = true)
     ...
     * 构造方法
     */
    public TaskEntityWithGettersSetters() {
