...
public interface TaskService {
     ...
     * @return 任务执行结果
     */
    TaskTriggerResponse triggerTask(Long id);
     ...
     * @return 历史版本列表
     */
    List<TaskVersionResponse> getTaskVersions(Long id);
     ...
     * @return 验证结果
     */
    TaskFlowValidateResponse validateTaskFlow(Long taskId);
     ...
     * @return 重试结果
     */
    BatchRetryResponse batchRetryTaskErrorData(List<Long> errorDataIds);
     ...
     * @return 向量化预览结果
     */
    VectorizationPreviewResponse generateVectorizationPreview(VectorizationConfigEntity config, String sourceData);
     ...
     * @return 任务执行历史列表
     */
    List<java.util.Map<String, Object>> getTaskExecutionHistory(Long taskId, int limit);
     ...
     * @return 版本号
     */
    int saveTaskVersion(TaskEntity taskEntity);
     ...
     * @return 是否回滚成功
     */
    boolean rollbackTaskToVersion(Long taskId, int version);
